...
# Napisz program generujący wszystkie podzbiory zbioru {1,2,...,n} w
# kolejności zgodnej z ich liczebnością (najpierw zbiór pusty, potem
# zbiory 1-elementowe, następnie 2-elementowe itd.). Algorytm nie musi
# być efektywny! Wykorzystaj program z zadania 4 z poprzednich ćwiczeń.
...
class Generator:
    ...
    def sort_ranks(self, n, somelist):
        # tworzy nową listę, przeglądając poprzednią i wybierając
        # elementy o danej liczbie jedynek (kolejno)
        sortedlist = []
        for i in range(n+1):
            ones = 0
